...
const moviesToAdd = [
  ...
  { title: 'The Last 7 Days', category: 'tv-show' },
  { title: 'Triangle', category: 'movie' },
  { title: 'Money Explained', category: 'tv-show' },
  { title: 'Get Smart with Money', category: 'movie' },
  { title: 'Life in Pieces', category: 'tv-show' },
  { title: 'How to Get Rich', category: 'tv-show' },
  { title: 'Everybody Loves Touda', category: 'tv-show' },
