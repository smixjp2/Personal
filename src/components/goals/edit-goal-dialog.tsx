...
type FormValues = Omit<z.infer<typeof goalSchema>, 'dueDay' | 'dueMonth'> & { dueDate: string };

type EditGoalDialogProps = {
  children: React.ReactNode;
  goal: Goal;
  onEditGoal: (goal: Partial<Omit<Goal, 'id'>>) => void;
};

export function EditGoalDialog({ children, goal, onEditGoal }: EditGoalDialogProps) {
  ...
  const form = useForm<z.infer<typeof goalSchema>>({
    ...
    defaultValues: {
      ...
      dueMonth: (dueDate.getMonth() + 1).toString(),
    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="sm:max-w-lg">
        <DialogHeader>
          ...
          <DialogDescription>
            Mettez à jour les détails de votre objectif pour 2026.
          </DialogDescription>
        </DialogHeader>
        <Form {...form}>
            ...
            <FormItem>
              ...
              <div className="grid grid-cols-3 gap-2">
                ...
                <FormField control={form.control} name="dueMonth" render={({ field }) => (
                 ...
                 <FormItem><FormControl><Input placeholder="Année" value="2026" disabled /></FormControl></FormItem>
              </div>
