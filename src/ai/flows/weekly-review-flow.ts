...
Analyze the provided data: habit progress, and goal and project statuses.
...
3.  **Accomplishments**: Create a list of 3-4 key achievements from the past week. Focus on significant progress on habits, goals, or projects.
4.  **Suggestions**: Provide a list of 3-4 actionable suggestions for the upcoming week. These should be based on active goals and projects in progress to help the user prioritize.
